  ...
  <v-card>
    ...
    >
      <v-card class="text-center">
        <v-card-title class="text-h5 bg-red-lighten-2" style="justify-content: center">
          Erreur d'impression !
        </v-card-title>
      ...
      <v-row class="pa-0 ma-0 pr-4">
        ...
        <v-col v-if="selected"
          ...
          <v-row v-if="variableWeightProduct()">
            <v-col>
              <h2 :class="weight>0&&weight<100?'text-right':'text-orange text-right'">
                Poids :
              </h2>
            </v-col>
            <v-col>
              <h2 :class="weight>0&&weight<100?'text-left':'text-orange'">
